 ...
 * Product holds all information on price points, descriptors and URL to the product on the
 * company's website.
 * 
 * @Updated - 12/21/2015
 * TODO:
...
public class MF_Product {
	...
	public int compareTo(MF_Product product) {
		if (this.UPC.equals(product.getUPC())) {
			...
			if (this.weight * 1.1 >= product.getWeight()
					&& this.weight * 0.9 <= product.getWeight()) {
				return 1;
			}
		}
		return 0;
	...
	/**
	 * Prints a stream with the variables from this class. Primarily used for development and
	 * testing.
	 */
	public void print() {
